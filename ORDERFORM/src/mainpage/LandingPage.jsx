...
const S = {
  ...
  // modal styles
  overlayWrap: { position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.6)', backdropFilter: 'blur(3px)', zIndex: 1000, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '16px', boxSizing: 'border-box' },
  modal: { background: 'white', borderRadius: '28px', width: '100%', maxWidth: '480px', maxHeight: '85vh', overflowY: 'auto', overflowX: 'hidden', position: 'relative', boxShadow: '0 30px 50px rgba(0,0,0,0.3)', boxSizing: 'border-box' },
  modalHeader: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '22px 26px 16px', borderBottom: '1px solid #eef2f8', boxSizing: 'border-box' },
  ...
  modalBody: { padding: '20px 26px 28px', boxSizing: 'border-box' },
  formGroup: { marginBottom: '16px', boxSizing: 'border-box' },
  label: { display: 'block', fontSize: '13px', color: '#475569', marginBottom: '6px', fontWeight: 600 },
  input: { width: '100%', padding: '12px 14px', border: '1.5px solid #e2e8f0', borderRadius: '16px', fontSize: '14px', outline: 'none', transition: 'border 0.2s', boxSizing: 'border-box', display: 'block' },
  btnBlock: { width: '100%', padding: '14px', background: '#0a2b44', color: 'white', border: 'none', borderRadius: '40px', fontSize: '14px', cursor: 'pointer', fontWeight: 700, marginTop: '12px', boxSizing: 'border-box' },
